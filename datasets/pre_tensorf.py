...
def main():
    ...
    out_dir = os.path.join(out_dir, f'{dataset_name}_tensorf', scene_name)

    dirs_mapping = {
        #'images': 'images',
        f'images_{down_factor}': f'images_4',
    ...
    check_output('rm -r {}'.format(
        os.path.join(out_dir, "images_4", "masks")), shell=True)
